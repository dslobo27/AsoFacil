$(document).ready(function () {
    var oTable = $("#table-status-solicitacoes-ativacao").DataTable({
        ...
        responsive: true,
        ajax: {
            url: '/statussolicitacaoativacao/getasync',
            data: function (d) {
    ...
    oTable.on('click', '.btn-editar', function (e) {
        ...
        $.ajax({
            ...
            url: '/statussolicitacaoativacao/modal/',
            async: true,
            dataType: "html",
    ...
    $('#btn-salvar').click(function (e) {
        ...
        $.ajax({
            type: type,
            url: '/statussolicitacaoativacao/' + action,
            data: JSON.stringify(model),
            async: true,
            dataType: "json",
            contentType: "application/json; charset=utf-8",
    ...
    $('#btn-confirmar').click(function (e) {
        ...
        let statusSolicitacaoAtivacaoId = $('#id-exclusao').val();

        $.ajax({
            type: 'DELETE',
            url: '/statussolicitacaoativacao/deleteasync/' + statusSolicitacaoAtivacaoId,
            async: true,
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            beforeSend: function () {

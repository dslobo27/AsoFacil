...
{
    public class StatusAgendamentosControllerTest
    {
        private readonly ClaimsPrincipal _user;
        private readonly StatusAgendamentosController _controller;
        private readonly IStatusAgendamentoApplicationService _service;

        public StatusAgendamentosControllerTest()
        {
            ...
            _controller = Substitute.For<StatusAgendamentosController>();
            _controller.ControllerContext.HttpContext = new DefaultHttpContext() { User = _user };

            _service = Substitute.For<IStatusAgendamentoApplicationService>();
        }
        ...
        public async Task ShouldGetAsync()
        {
            ...
            _service.ObterAsync(Arg.Any<string>())
                .ReturnsForAnyArgs(new List<StatusAgendamentoModel> {
                    new StatusAgendamentoModel()
                });
        ...
        public async Task ShouldGetByIdAsync()
        {
            ...
            _service.ObterPorIdAsync(Arg.Any<Guid>())
                .ReturnsForAnyArgs(new StatusAgendamentoModel());
        ...
        {
            var model = new ManterStatusAgendamentoModel
            {
                Id = Guid.NewGuid(),
                Descricao = "descricao"
            };

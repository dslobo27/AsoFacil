...
{
    public class StatusSolicitacoesAtivacoesEmpresasControllerTest
    {
        private readonly ClaimsPrincipal _user;
        private readonly StatusSolicitacoesAtivacoesEmpresasController _controller;
        private readonly IStatusSolicitacaoAtivacaoEmpresaApplicationService _service;

        public StatusSolicitacoesAtivacoesEmpresasControllerTest()
        {
            ...
            _controller = Substitute.For<StatusSolicitacoesAtivacoesEmpresasController>();
            _controller.ControllerContext.HttpContext = new DefaultHttpContext() { User = _user };

            _service = Substitute.For<IStatusSolicitacaoAtivacaoEmpresaApplicationService>();
        }
        ...
        public async Task ShouldGetAsync()
        {
            ...
            _service.ObterAsync(Arg.Any<string>(), Arg.Any<string>())
                .ReturnsForAnyArgs(new List<StatusSolicitacaoAtivacaoEmpresaModel> {
                    new StatusSolicitacaoAtivacaoEmpresaModel()
                });
        ...
        public async Task ShouldGetByIdAsync()
        {
            ...
            _service.ObterPorIdAsync(Arg.Any<Guid>())
                .ReturnsForAnyArgs(new StatusSolicitacaoAtivacaoEmpresaModel());
        ...
        {
            var model = new ManterStatusSolicitacaoAtivacaoEmpresaModel
            {
                Id = Guid.NewGuid(),
                Codigo = "codigo",
                Descricao = "descricao"
